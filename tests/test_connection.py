...
class ConnectionTest(unittest.TestCase):
    ...
    def test_login(self, lib_mock):
        ...
        lib_mock.SpConnectionLoginPassword.assert_called_once_with(
            mock.ANY, mock.ANY)
        self.assertEqual(
    ...
    def test_login_blob(self, lib_mock):
        ...
        lib_mock.SpConnectionLoginBlob.assert_called_once_with(
            mock.ANY, mock.ANY)
        self.assertEqual(
            spotifyconnect.ffi.string(
...
class ConnectionCallbacksTest(unittest.TestCase):
    ...
    def test_connection_new_credentials_callback(self, lib_mock):
        ...
        session.connection.on(
            spotifyconnect.ConnectionEvent.NEW_CREDENTIALS, callback)
...
class DebugCallbacksTest(unittest.TestCase):
    ...
    def test_debug_message_callback(self, lib_mock):
        ...
        session_handle = spotifyconnect.ffi.new_handle(session)
        session.connection.on(
            spotifyconnect.DebugEvent.DEBUG_MESSAGE, callback)
